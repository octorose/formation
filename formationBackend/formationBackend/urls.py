...
from api.views import CreateSupervisorView, CreatePersonnelView, RegisterView,EditFormateurView, CustomTokenObtainPairView,EditResponsableFormationEcoleView,CreateResponsableFormationEcoleView,CreateFormateurView, CreateContratView, EditContratView
